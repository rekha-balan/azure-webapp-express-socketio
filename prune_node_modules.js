...
class Main {
    ...
    constructor() {
        ...
        this.delete_types.push('.DS_Store');    
        this.delete_types.push('.gitignore'); 
        this.delete_types.push('Gruntfile.js'); 
        this.delete_types.push('gulpfile.js'); 
